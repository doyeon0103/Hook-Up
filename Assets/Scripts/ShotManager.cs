...
public class ShotManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject goCheckPoint2;
    [SerializeField] private GameObject goCheckPoint3;
    [SerializeField] private GameObject goCheckPoint4;
    ...
    void OnTriggerEnter2D(Collider2D CheckPoint)
    {
        ...
        else if (CheckPoint.tag == "CheckPoint2")
        {
            goCheckPoint2.tag = ("Untagged");
            checkPoint.setColor();
            trsPlayerCheckPoint = goCheckPoint2.transform.position;
        }
        else if (CheckPoint.tag == "CheckPoint3")
        {
            goCheckPoint3.tag = ("Untagged");
            checkPoint.setColor();
            trsPlayerCheckPoint = goCheckPoint3.transform.position;
        }
        else if (CheckPoint.tag == "CheckPoint4")
        {
            goCheckPoint4.tag = ("Untagged");
            checkPoint.setColor();
            trsPlayerCheckPoint = goCheckPoint4.transform.position;
        }
    }
    ...
    {
        SceneManager.LoadScene("EscapeSceneNormal", LoadSceneMode.Additive);
    ...
    {
        SceneManager.UnloadSceneAsync("EscapeSceneNormal");
